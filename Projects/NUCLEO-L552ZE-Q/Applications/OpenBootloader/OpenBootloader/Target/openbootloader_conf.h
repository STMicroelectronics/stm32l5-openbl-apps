...
#define DEVICE_ID_LSB                     0x72U  /* LSB byte of device ID */
...
#define ICP1_SIZE                         (32U * 1024U)  /* Size of ICP 32 kByte */
#define ICP1_START_ADDRESS                0x0BF90000U  /* System memory registers address */
#define ICP1_END_ADDRESS                  (ICP1_START_ADDRESS + ICP1_SIZE)  /* System memory registers end address */

#define OB1_SIZE                          48U  /* Size of OB 48 Byte */
#define OB1_START_ADDRESS                 0x40022040U  /* Option bytes registers address */
...
#define EB_SIZE                           752U  /* Size of Engi bytes 752 Byte */
...
#define OPENBL_RAM_SIZE                   (16U * 1024U)  /* RAM used by the Open Bootloader 16 kBytes */
